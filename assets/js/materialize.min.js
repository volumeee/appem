    ...
    function(t) {
        t(document).ready(function() {
            ...
            Materialize.updateTextFields = function() {
                t("input[type=text], input[type=password], input[type=username], input[type=url], input[type=tel], input[type=number], input[type=search], textarea").each(function(e, i) {
                    var n = t(this);
            ...
            var i = "input[type=text], input[type=password], input[type=username], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";
